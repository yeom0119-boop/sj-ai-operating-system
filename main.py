"""SJ AI Operating System v0.9 command-line menu."""
...
def print_menu() -> None:
    """Print the v0.9 main menu."""
    print()
    print("=========================")
    print("SJ AI Operating System v0.9")
    print("=========================")
...
def main() -> None:
    """Run the SJ AI Operating System v0.9 interactive menu."""
    _configure_stdout()
    while True:
        print_menu()
        try:
