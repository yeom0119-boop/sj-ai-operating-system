...
class MainMenuTests(unittest.TestCase):
    ...
    def test_print_menu_shows_v0_4_options(self) -> None:
        """The menu displays the required v0.4 labels."""
        buffer = io.StringIO()
        ...
        self.assertIn("SJ AI Operating System v0.4", output)
        ...
        self.assertIn("5. Search all notes", output)
        self.assertIn("6. List recent notes", output)
    ...
    def test_main_rejects_invalid_choice(self) -> None:
        ...
        output = buffer.getvalue()
        self.assertIn("Error: please enter a number from 1 to 7.", output)
